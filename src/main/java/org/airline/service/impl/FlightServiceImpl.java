...
public class FlightServiceImpl implements FlightService {
    ...
    @Override
    @Transactional
    public BulkFlightResult bulkCreateFlightsAndRuns(List<org.airline.dto.flight.FlightRequest> flights) {
        int flightsCreated = 0;
        int runsCreated = 0;
        List<String> successNames = new ArrayList<>();
        List<String> failedNames = new ArrayList<>();
        for (org.airline.dto.flight.FlightRequest req : flights) {
            try {
