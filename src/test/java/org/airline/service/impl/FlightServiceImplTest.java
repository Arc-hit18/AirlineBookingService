...
public class FlightServiceImplTest {
    ...
    void testBulkCreate_successAndFail() {
        ...
        List<org.airline.dto.flight.FlightRequest> reqs = List.of(
            buildReq("A"),
            buildReq("B")
        );
    ...
    private org.airline.dto.flight.FlightRequest buildReq(String name) {
        org.airline.dto.flight.FlightRequest req = new org.airline.dto.flight.FlightRequest();
